...
<div id="userAdd" class="easyui-window" title="新增会员" data-options="modal:true,closed:true,iconCls:'icon-save',href:'${pageContext.request.contextPath }/user/page/add'" style="width:415px;height:310px;padding:10px;">
        The window content.
</div>
...
var toolbar = [{
    ...
    handler:function(){
    	...
    	$.messager.confirm('确认','确定删除ID为 '+ids+' 的会员吗？',function(r){
    	    if (r){
            	$.post("${pageContext.request.contextPath }/rest/user",{'ids':ids, "_method": "DELETE"}, function(data, text, xhr){
        			if(xhr.status == 204){
